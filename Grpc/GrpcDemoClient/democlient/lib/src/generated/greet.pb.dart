...
class ReadStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadStatusRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'greet'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  ReadStatusRequest._() : super();
  factory ReadStatusRequest({
    $core.int? id,
  }) {
    final _result = create();
    if (id != null) {
  ...
  factory ReadStatusRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReadStatusRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ReadStatusRequest clone() => ReadStatusRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadStatusRequest copyWith(void Function(ReadStatusRequest) updates) => super.copyWith((message) => updates(message as ReadStatusRequest)) as ReadStatusRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReadStatusRequest create() => ReadStatusRequest._();
  ReadStatusRequest createEmptyInstance() => create();
  static $pb.PbList<ReadStatusRequest> createRepeated() => $pb.PbList<ReadStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static ReadStatusRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReadStatusRequest>(create);
  static ReadStatusRequest? _defaultInstance;
...
class ReadStatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadStatusResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'greet'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status')
    ..hasRequiredFields = false
  ;

  ReadStatusResponse._() : super();
  factory ReadStatusResponse({
    $core.String? status,
  }) {
    final _result = create();
    if (status != null) {
  ...
  factory ReadStatusResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReadStatusResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ReadStatusResponse clone() => ReadStatusResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadStatusResponse copyWith(void Function(ReadStatusResponse) updates) => super.copyWith((message) => updates(message as ReadStatusResponse)) as ReadStatusResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReadStatusResponse create() => ReadStatusResponse._();
  ReadStatusResponse createEmptyInstance() => create();
  static $pb.PbList<ReadStatusResponse> createRepeated() => $pb.PbList<ReadStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static ReadStatusResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReadStatusResponse>(create);
  static ReadStatusResponse? _defaultInstance;
