namespace Loupedeck.Demo01Plugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Demo01Plugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Demo01Plugin.Resources.Resource.txt`.
