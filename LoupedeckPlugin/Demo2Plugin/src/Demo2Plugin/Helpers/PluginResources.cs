namespace Loupedeck.Demo2Plugin
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Demo2Plugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Demo2Plugin.Resources.Resource.txt`.
